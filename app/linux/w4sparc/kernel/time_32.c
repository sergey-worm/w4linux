...
static __init void setup_timer_ce(void)
{
	...
	//BUG_ON(smp_processor_id() != boot_cpu_id);  // wrm:  commented
...
unsigned long long l4_system_clock(void);
...
static u64 timer_cs_read(struct clocksource *cs)
{
	...
	// wrm
	//   HZ - cause tick period 1 sec, but expected 1/HZ msec
	// 1000 - convert usec to msec
	return l4_system_clock() / HZ / 1000;
	// ~wrm
